...
> = {
  about: {
    title: 'XAIKOREA | ABOUT',
    description:
      '도메인 지식과 AI 기술을 연결해 설명할 수 있는 의사결정 경험을 만드는 XAIKOREA를 소개합니다.',
  },
  work: {
    title: 'XAIKOREA | WORK',
    description:
      '연구, 문서 검토, AI 거버넌스 분야의 XAIKOREA 프로젝트와 구축 역량을 확인하세요.',
  },
  careers: {
    title: 'XAIKOREA | CAREERS',
    description:
      '신뢰할 수 있는 AI의 기준을 함께 만드는 XAIKOREA의 채용과 업무 문화를 소개합니다.',
  },
  contact: {
    title: 'XAIKOREA | CONTACT',
    description:
      '지식 탐색, 문서 검토, AI 거버넌스 프로젝트를 XAIKOREA와 상담하세요.',
  },
};
...
const projects: Project[] = [
  {
    ...
    category: 'RESEARCH',
    caption: '연구 근거 탐색 및 출처 연결',
    image: '/assets/images/company/cloa-evidence-vault.jpg',
    result: '리서치 시간 85% 단축',
    tone: 'blue',
    tall: true,
    contain: true,
  },
  {
    title: 'Tax Navigator',
    category: 'TAX',
    caption: '세무 규정·판례 질의 시스템',
    image: '/assets/images/company/codebase-intelligence-platform.jpg',
    result: '답변 근거 추적률 100%',
    tone: 'red',
    contain: true,
  },
  {
    title: 'Policy Review',
    category: 'GOVERNANCE',
    caption: '규정 문서 비교 및 변경점 검토',
    image: '/assets/images/company/meeting-ai-security.jpg',
    result: '검토 처리량 3.2배',
    tone: 'black',
    tall: true,
    contain: true,
  },
  {
    title: 'Agent Harness',
    category: 'RESEARCH',
    caption: '에이전트 하네스 엔지니어링 교육·실험',
    image: '/assets/images/company/agent-harness-engineering.jpg',
    result: 'AI 엔지니어링 체계화',
    tone: 'ivory',
  },
  {
    title: 'Hoban AI Voice',
    category: 'GOVERNANCE',
    caption: '회의 녹음·전사·화자 분리 기반 지식 워크스페이스',
    image: '/assets/images/company/hoban-ai-workspace.jpg',
    result: '안전한 온프레미스 연결',
    tone: 'navy',
  },
  {
    title: 'Edge AI Lab',
    category: 'RESEARCH',
    caption: 'Raspberry Pi 기반 엣지 AI 검증 환경',
    image: '/assets/images/company/raspberry-pi-edge.jpg',
    result: '현장형 프로토타입 구축',
    tone: 'grey',
  },
  {
    ...
    category: 'GOVERNANCE',
    caption: '로컬 데이터 보호를 위한 저장·연산 인프라',
    image: '/assets/images/company/edge-storage-array.jpg',
    result: '데이터 통제 범위 강화',
    tone: 'mint',
  },
  {
    ...
    category: 'GOVERNANCE',
    caption: 'AI 전환 전략과 신뢰 운영 기준 연구',
    image: '/assets/images/company/ai-transformation-conference.jpg',
    result: '산업 현장 인사이트 연결',
    tone: 'sand',
    tall: true,
  },
  {
    title: 'Technology Protection',
    category: 'GOVERNANCE',
    caption: '기술보호 선도기업 운영 체계',
    image: '/assets/images/company/technology-protection-company.jpg',
    result: '기술·지식재산 보호 강화',
    tone: 'violet',
  },
  {
    title: 'On-Premise AI',
    category: 'RESEARCH',
    caption: '조직 내부에서 운영되는 AI 인프라 실증',
    image: '/assets/images/company/server-mainboard.jpg',
    result: '폐쇄망·로컬 환경 대응',
    tone: 'orange',
  },
  {
    ...
    category: 'RESEARCH',
    caption: '도메인 지식과 컴퓨팅 환경의 통합 검증',
    image: '/assets/images/company/engineering-at-work.jpg',
    result: '현장 중심 검증 루프',
    tone: 'white',
  },
  {
    title: 'Decision Room',
    category: 'TAX',
    caption: '근거 중심 의사결정과 협업을 위한 공간',
    image: '/assets/images/company/office-lounge.jpg',
    result: '판단 맥락 구조화',
    tone: 'green',
    tall: true,
  },
...
const businessItems = [
  [
    '01',
    'KNOWLEDGE\nDISCOVERY',
    '문서와 데이터, 외부 기준을 하나의 질문 경험으로 연결하고 원문에 닿는 답변을 설계합니다.',
  ],
  [
    '02',
    'DOCUMENT\nINTELLIGENCE',
    '계약·정책·세무 문서의 쟁점과 변경점을 비교하고 사람이 확인할 검토 지점을 제시합니다.',
  ],
  [
    '03',
    'TRUSTED AI\nOPERATIONS',
    '권한, 출처, 평가, 승인 이력을 묶어 조직이 안심하고 운영할 수 있는 구조를 만듭니다.',
  ],
  [
    '04',
    'AI STRATEGY\n& CONSULTING',
    '업무 진단부터 파일럿, 품질 기준과 확산 계획까지 실제 도입에 필요한 경로를 함께 설계합니다.',
  ],
] as const;
...
const awards = [
  [
    '2026.08',
    '온프레미스 AI 회의 인텔리전스 플랫폼 GUI·아이콘 디자인 화면집 v1.0',
    '저작권 등록 · 08.11',
    '/assets/images/company/office-design-wall.jpg',
  ],
  [
    '2026.08',
    '온프레미스 AI 회의 인텔리전스 플랫폼 v1.0',
    '프로그램 저작권 · 08.03',
...
const recruitParts = [
  [
    'PLANNING',
    '고객의 핵심 가치를 정의하고 복잡한 업무를 명료한 제품 흐름으로 설계합니다.',
  ],
  [
    'DESIGN',
    '정보의 우선순위와 사용자의 판단 과정을 시각적 경험으로 바꿉니다.',
  ],
  [
    'AI ENGINEERING',
    '검색·생성·평가 기술을 검증 가능한 서비스 구조로 구현합니다.',
  ],
  [
    'DOMAIN RESEARCH',
    '법·세무·정책·연구 자료를 분석하고 AI가 이해할 지식 체계로 정리합니다.',
  ],
] as const;
...
const workspaceSlides = [
  [
    '/assets/images/company/open-workspace.jpg',
    '판교 배민스퀘어의 집중 업무 공간',
  ],
  [
    '/assets/images/company/office-lounge.jpg',
    '아이디어와 대화를 이어가는 오픈 라운지',
  ],
  [
    '/assets/images/company/engineering-at-work.jpg',
    'AI 인프라를 직접 검증하는 엔지니어링 현장',
  ],
] as const;
...
function AgencyHeader({ current }: { current: AgencyPageType }): ReactElement {
  ...
  const [preview, setPreview] = useState(
    previewImages[`/${current}`] ?? previewImages['/']
  );
  ...
  return (
    <>
      ...
      >
        <Link className="rp-brand" to="/" aria-label="XAIKOREA home">
    ...
    <footer className="rp-footer">
      ...
      <div className="rp-footer__grid">
        <div className="rp-footer__company">
          <img
            src="/assets/images/logo/xaikorea-corporate.png"
            alt="XAIKOREA 로고"
          />
          <div>
            <span>Company</span>
            <strong>XAIKOREA</strong>
          </div>
        </div>
        <div className="rp-footer__address">
          <span>Address</span>
    ...
    <>
      <section className="rp-hero rp-hero--about">
        ...
        <div className="rp-hero__copy">
          ...
          <span>
            도메인 지식과 AI 기술을 연결해, 설명할 수 있는 의사결정 경험을
            만듭니다.
          </span>
        </div>
        <a href="#business" className="rp-scroll-cue">
          SCROLL <i />
        </a>
      </section>
      <section id="business" className="rp-section rp-business rp-reveal">
        ...
        <div className="rp-business__grid">
          {businessItems.map(([number, title, description]) => (
            <article key={number}>
              <span>{number}</span>
              <h3>
                {title.split('\n').map((line) => (
      ...
      <section className="rp-section rp-awards rp-reveal">
        ...
        <p className="rp-section-lead">
          공식 확인서와 한국저작권위원회 등록증을 기준으로 검증된 이력만
          안내합니다.
        </p>
        <div className="rp-awards__layout">
          <div className="rp-awards__list">
            {awards.map(([year, title, result, image]) => (
              <button
                key={title}
                type="button"
                onPointerEnter={() => {
                  setAwardPreview(image);
                }}
                onFocus={() => {
                  setAwardPreview(image);
                }}
          ...
          <div className="rp-awards__preview">
            <img
              key={awardPreview}
              src={awardPreview}
              alt="선택한 이력 미리보기"
  ...
  return (
    <>
      <section className="rp-work-intro">
        ...
        <span>
          복잡한 지식과 기술을 누구나 확인하고 실행할 수 있는 경험으로 바꿉니다.
        </span>
      </section>
      <section className="rp-work-grid-section rp-reveal">
        <div className="rp-filter" role="toolbar" aria-label="프로젝트 필터">
          {(['ALL', 'RESEARCH', 'TAX', 'GOVERNANCE'] as ProjectCategory[]).map(
            (item) => (
              <button
                key={item}
                type="button"
        ...
        <div className="rp-project-grid" aria-live="polite">
          {visibleProjects.map((project) => (
            <button
              className={`rp-project rp-project--${project.tone} ${(project.tall ?? false) ? 'is-tall' : ''} ${(project.logo ?? false) ? 'is-logo' : ''} ${(project.contain ?? false) ? 'is-contain' : ''}`}
              type="button"
              key={project.title}
            ...
            >
              ...
              <span className="rp-project__number">
                {String(projects.indexOf(project) + 1).padStart(2, '0')}
              </span>
              <span className="rp-project__copy">
      ...
      <div
        className={`rp-project-modal ${selected !== null ? 'is-open' : ''}`}
        role="dialog"
        aria-modal="true"
        aria-hidden={selected === null}
        aria-label="프로젝트 상세 미리보기"
      >
        {selected !== null && (
          <div className="rp-project-modal__panel">
            <button
              className="rp-project-modal__close"
              type="button"
              onClick={() => {
                setSelected(null);
              }}
            ...
            <div
              className={`rp-project-modal__visual ${(selected.contain ?? false) ? 'is-contain' : ''}`}
            >
              <img src={selected.image} alt="" />
            </div>
            <div className="rp-project-modal__copy">
              <span>{selected.category} · XAIKOREA</span>
...
function CareersPage(): ReactElement {
  ...
  const moveSlide = (direction: number): void => {
    setSlide(
      (value) =>
        (value + direction + workspaceSlides.length) % workspaceSlides.length
    );
  };
    ...
    <>
      <section className="rp-hero rp-hero--careers">
        ...
        <div className="rp-hero__copy">
          ...
          <span>
            오늘보다 더 나은 질문을 던지고, 신뢰할 수 있는 AI의 기준을 함께
            만듭니다.
          </span>
        </div>
        <a href="#recruit" className="rp-scroll-cue">
          JOIN THE TEAM <i />
        </a>
      </section>
      <section id="recruit" className="rp-section rp-recruit rp-reveal">
        ...
        <div className="rp-recruit__grid">
          {recruitParts.map(([title, text]) => (
            <article key={title}>
              <h3>{title}</h3>
              <p>{text}</p>
              <a href="mailto:contact@xaikorea.ai.kr?subject=XAI%20Korea%20채용%20문의">
                OPEN APPLICATION ↗
              </a>
            </article>
          ))}
      ...
      <section className="rp-section rp-welfare rp-reveal">
        ...
        <p className="rp-section-lead">
          좋은 결과는 오래 몰입할 수 있는 환경에서 나온다고 믿습니다.
        </p>
        <div className="rp-welfare__grid">
          {welfare.map(([number, title, text]) => (
            <article key={number}>
              <span>{number}</span>
              <i aria-hidden="true" />
              <h3>{title}</h3>
      ...
      <section className="rp-section rp-workspace rp-reveal">
        <div className="rp-workspace__copy">
          <div className="rp-section-title">
            <span>04</span>
            <h2>WORKSPACE</h2>
          </div>
          <p>{workspaceSlides[slide]?.[1]}</p>
          <div>
            <button
              type="button"
              onClick={() => {
        ...
        <div className="rp-workspace__visual">
          <img
            key={workspaceSlides[slide]?.[0]}
            src={workspaceSlides[slide]?.[0]}
            alt={workspaceSlides[slide]?.[1]}
          />
          <span>{String(slide + 1).padStart(2, '0')} / 03</span>
        </div>
      </section>
      <section className="rp-career-cta">
...
export default function AgencyPage({ page }: AgencyPageProps): ReactElement {
  ...
  useEffect(() => {
    ...
    document
      ...
      ?.setAttribute('href', `${window.location.origin}/${page}`);
  ...
  return (
    <div className={`rp-site rp-site--${page}`}>
      <a className="rp-skip" href="#agency-main">
        본문 바로가기
      </a>
      <AgencyHeader current={page} />
      <span className="rp-side-label" aria-hidden="true">
        {page.toUpperCase()}
      </span>
      <main id="agency-main">
